...
public class BarChartScaleAnimation implements EventHandler<MouseEvent>
{
	...
	public BarChartScaleAnimation(BarChart<String, Number> chart, Data<String, Number> item, boolean entered) {
		this.data = item;
